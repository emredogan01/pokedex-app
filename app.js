...
const searchIntput = document.querySelector('.searchInput')
...
searchIntput.addEventListener('input', () => {
    // console.log(searchIntput.value)
    const searchValue = searchIntput.value.toLowerCase()
